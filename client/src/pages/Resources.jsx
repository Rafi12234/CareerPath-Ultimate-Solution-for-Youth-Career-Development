      ...
      <div className="relative z-10 max-w-300 mx-auto px-6 sm:px-8 lg:px-12">
        ...
        <div className="max-w-2xl mx-auto mb-8">
          <div className="relative">
            ...
            <input
              ...
              className="w-full pl-11 pr-4 py-3.5 bg-dark-card border border-dark-border rounded-xl text-white placeholder-gray-600 focus:border-primary/50 focus:ring-1 focus:ring-primary/20 transition-all duration-200"
            />
          </div>
        </div>
        ...
        {user && (
          <div className="flex justify-center mb-8">
            <span className="inline-flex items-center gap-2 px-4 py-2 bg-primary/10 border border-primary/20 rounded-full text-sm text-primary-light">
          ...
          <div className="grid sm:grid-cols-2 lg:grid-cols-3 gap-5 sm:gap-6">
            {filteredCourses.map((course, index) => {
              ...
              return (
                <div
                  key={course.id}
                  className="group bg-dark-card/80 border border-dark-border/60 rounded-2xl overflow-hidden hover:border-primary/25 transition-all duration-300 hover:-translate-y-1 hover:shadow-xl hover:shadow-primary/5"
                >
                  {/* Image */}
                  ...
                  {/* Content */}
                  <div className="p-5">
                    <h3 className="text-base font-bold text-white mb-2 group-hover:text-primary-light transition-colors duration-200 line-clamp-1">
                      {course.name}
                    </h3>
                    ...
                    <div className="flex gap-2.5">
                      <button
                        ...
                        className="flex-1 py-2.5 border border-dark-border rounded-xl text-gray-400 text-sm font-medium hover:border-primary/40 hover:text-white transition-all duration-200 cursor-pointer"
                      >
                        View Details
                      </button>
                      {enrolled ? (
                        <button
                          ...
                          className="flex-1 py-2.5 bg-accent hover:bg-accent-dark rounded-xl text-white text-sm font-semibold transition-all duration-200 disabled:opacity-50"
                        >
                        ...
                        <button
                          ...
                          disabled={actionLoading === course.id}
                          className="flex-1 py-2.5 bg-primary hover:bg-primary-dark rounded-xl text-white text-sm font-semibold transition-all duration-200 shadow-lg shadow-primary/20 hover:shadow-primary/30 disabled:opacity-50"
                        >
        ...
        return (
          ...
          >
            ...
            <div
              ...
              className="relative w-full max-w-2xl max-h-[90vh] overflow-y-auto bg-dark-card border border-dark-border/80 rounded-3xl shadow-2xl shadow-primary/10 animate-[modalIn_0.25s_ease-out]"
            >
              {/* Hero Image */}
              <div className="relative h-52 sm:h-60 overflow-hidden rounded-t-3xl">
                ...
                />
                <div className="absolute inset-0 bg-linear-to-t from-dark-card via-dark-card/40 to-transparent" />
              ...
              <div className="p-6 sm:p-8">
                ...
                <div className="mb-6">
                  <h4 className="text-sm font-bold text-white uppercase tracking-wider mb-2 flex items-center gap-2">
                    <ChevronRight size={14} className="text-primary" /> About This Course
                  </h4>
                ...
                <div className="mb-6">
                  <h4 className="text-sm font-bold text-white uppercase tracking-wider mb-3 flex items-center gap-2">
                    <Award size={14} className="text-accent" /> What You'll Learn
                  </h4>
                ...
                <div className="grid grid-cols-3 gap-3 mb-6">
                  <div className="bg-dark/50 border border-dark-border/40 rounded-xl p-4 text-center">
                    <Layers size={20} className="mx-auto text-primary-light mb-2" />
                ...
                {selectedCourse.topic && (
                  <div className="mb-6">
                    <h4 className="text-sm font-bold text-white uppercase tracking-wider mb-2 flex items-center gap-2">
                      <BookOpen size={14} className="text-primary-light" /> Topic
                    </h4>
                ...
                <div className="flex gap-3">
                  {enrolled ? (
                    <button
                      ...
                      className="flex-1 inline-flex items-center justify-center gap-2 px-6 py-3 bg-accent hover:bg-accent-dark rounded-xl text-white text-sm font-bold transition-all duration-200 disabled:opacity-50 cursor-pointer"
                    >
                    ...
                    <button
                      ...
                      disabled={actionLoading === selectedCourse.id}
                      className="flex-1 inline-flex items-center justify-center gap-2 px-6 py-3 bg-linear-to-r from-primary to-accent rounded-xl text-white text-sm font-bold hover:shadow-lg hover:shadow-primary/25 transition-all duration-200 hover:scale-[1.01] active:scale-[0.99] disabled:opacity-50 cursor-pointer"
                    >
                  ...
                  <button
                    onClick={() => setSelectedCourse(null)}
                    className="px-6 py-3 border border-dark-border rounded-xl text-gray-400 text-sm font-medium hover:border-primary/40 hover:text-white transition-all duration-200 cursor-pointer"
                  >
                    Close
                  </button>
                </div>
