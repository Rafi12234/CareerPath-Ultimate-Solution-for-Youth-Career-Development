...
try {
    ...
    DB::statement("CREATE TABLE IF NOT EXISTS course_videos (
    ...
    echo "✓ course_videos table created\n";

    echo "Creating video_completions table...\n";
    DB::statement("CREATE TABLE IF NOT EXISTS video_completions (
        id BIGINT UNSIGNED AUTO_INCREMENT PRIMARY KEY,
    ...
    echo "✓ video_completions table created\n";
    ...
    echo "✓ Seeded {$count} videos\n\n";
    echo "✅ Setup complete! Course video system is ready.\n";
